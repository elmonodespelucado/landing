...
export function NavBar() {
    ...
    return (
        <>
        <div className="max-w-4xl flex justify-center mx-auto mt-5">

        <Words words={words}/>
        </div>
        <nav className="flex items-center justify-center py-5 relative">
            <div className="md:flex-1  px-4 ">
                ...
                <div className=" sm:hidden">
                    <NavLink>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="icon icon-tabler icons-tabler-outline icon-tabler-menu-2"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M4 6l16 0" /><path d="M4 12l16 0" /><path d="M4 18l16 0" /></svg></NavLink>
                </div>
            </div>
            
            <div className="px-5 flex-1 md:flex justify-center">
                <Logo />
            </div>
            <div className="md:flex-1  px-4 text-sm md:text-base max-w-md">
